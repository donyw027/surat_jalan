            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'pendidikan'); ?> value="pendidikan" type="radio" id="pendidikan" name="role" class="custom-control-input">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'sdm'); ?> value="sdm" type="radio" id="sdm" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="sdm">Sdm</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'sekretariat'); ?> value="sekretariat" type="radio" id="sekretariat" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="sekretariat">Sekretariat</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'akunting'); ?> value="akunting" type="radio" id="akunting" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="akunting">Akunting</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'yayasan'); ?> value="yayasan" type="radio" id="yayasan" name="role" class="custom-control-input">
