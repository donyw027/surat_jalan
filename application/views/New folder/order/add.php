        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('produk'); ?>" type="text" id="produk" name="produk" class="form-control" placeholder="produk">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('orderby'); ?>" type="text" id="orderby" name="orderby" class="form-control" placeholder="orderby">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('deadline'); ?>" type="date" id="deadline" name="deadline" class="form-control" placeholder="deadline">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('harga'); ?>" type="text" id="harga" name="harga" class="form-control" placeholder="harga">
